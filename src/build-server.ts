...
/**
 * Build a fresh McpServer with the three bloodhound tools registered.
 * The stdio entry connects ONE of these for the process lifetime; the HTTP
 * transport builds one per request (stateless, matching brain-mcp).
 */
